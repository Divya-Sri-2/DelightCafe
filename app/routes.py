...
@main.route('/foodItems/<path:filename>')
def food_items(filename):
    return send_from_directory(os.path.join(os.path.dirname(os.path.dirname(__file__)), 'foodItems'), filename)
