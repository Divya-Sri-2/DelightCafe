...
function displayCart() {
    ...
    cart.forEach(item => {
        ...
        total += itemTotal;
        // Add image if available, else fallback to icon
        let itemImg = item.image
            ? `<img src="/static/images/foodItems/${item.image}" alt="${item.name}" class="cart-item-img me-3" style="width:44px;height:44px;object-fit:cover;border-radius:8px;">`
            : `<div class="bg-light rounded-circle d-flex align-items-center justify-content-center me-3" style="width: 44px; height: 44px;"><i class="fas fa-utensils text-primary"></i></div>`;
        cartHTML += `
            <div class="cart-item">
